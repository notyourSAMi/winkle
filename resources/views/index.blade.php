                        ...
                        <div class="one-forth d-flex js-fullheight align-items-center ftco-animate"
                            ...
                            <div class="text">
                                ...
                                <div class="horizontal">
                                    ...
                                    <p><a href="/About" class="btn btn-primary px-5 py-3 mt-3">Discover Now</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row d-flex no-gutters slider-text js-fullheight align-items-center justify-content-end"
                        ...
                        <div class="one-forth d-flex js-fullheight align-items-center ftco-animate"
                            ...
                            <div class="text">
                                <span class="subheading">Winkel eCommerce Shop</span>
                                <div class="horizontal">
                                    <h3 class="vr" style="background-image: url(images/divider.jpg);">Best
                    ...
                    <div class="col-sm col-md-6 col-lg ftco-animate">
                        <div class="product">
                            ...
                            <div class="text py-3 px-3">
                                ...
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span class="price-sale">{{ $product->p_price }}</span></p>
                                    </div>

                                </div>
                                <p class="bottom-area d-flex px-3">
                                    <a href="{{route('addbook.to.cart', $product->p_id)}}" class="add-to-cart text-center py-2 mr-1"><span>Add to cart <i
            ...
            <div class="row">
                ...
                <div class="col-md-4 py-md-5 ftco-animate">
                    <div class="text py-3 py-md-5">
                        <h2 class="mb-4"><span class="imgtext">NEW MEN'S</span> PERFUME SUMMER <span
                                class="imgtext">COLLECTIO</span>N 2019</h2>
                        <p><span class="imgtext">Deep within fragrant gar</span>dens, nestled far from the lands of
                            Vokalia and <span class="imgtext">Consonantia, there
                                exist</span> the aromatic notes of perfumes. These scents, each <span
                                class="imgtext">with its own unique char</span>acter,
                            reside in Perfumegrove, situated along the <span class="">shores of the
                                Fragrance</span> Sea, a vast realm of
            ...
            <div class="row">
                ...
                <div class="col-md-7 py-3 py-md-5 ftco-animate">
                    <div class="text text-2 py-md-5">
                        <h2 class="mb-4">New Men's Shoes Summer Collection 2019</h2>
                        <p>Far away, hidden behind the word 'footwear,' distant from the regions of Vokalia and
                            Consonantia, reside the unassuming shoe designs. Isolated, they inhabit Shoeland, located
                            right along the shores of the Semantics, a vast world of fashion.</p>
                        <p><a href="#" class="btn btn-white px-4 py-3">Shop now</a></p>
                    </div>
                </div>
            </div>
